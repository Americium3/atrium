...
| The Workshop | Bureau (work) | `127.0.0.1:8772` — local coding agent (OpenHands) |
...
The Workshop is the one gate behind a container rather than a script.
...
its launcher (`X:\Github\workshop\run_hidden.vbs`) waits for the Docker
